...
namespace TaxiCompany.Controllers
{
    public class BranchesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,City,Contactnumber")] Branch branch)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,City,Contactnumber")] Branch branch)
        {
            if (id != branch.ID)
            {
                return NotFound();
